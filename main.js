...
var dailyModifiers = {
	minDamage: {
		...
		plague: { //Half of electricity
			description: function (strength) {
                return "Enemies stack a debuff with each attack, damaging Trimps for " + prettify(this.getMult(strength, 1) * 100) + "% of total health per turn per stack, resets on Trimp death.";
            },
